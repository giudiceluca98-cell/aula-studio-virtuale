...
3. Rigenerare e verificare:
   ...
   pnpm build:web
   pnpm build:desktop
   pnpm release:check-version -- 1.4.0-alpha.11
   ```
...
6. Creare e inviare il tag corrispondente:
   ...
   ```powershell
   git tag v1.4.0-alpha.11
   git push origin v1.4.0-alpha.11
   ```
...
`1.4.0-alpha.11`. Il workflow pubblica comunque la release GitHub come release
