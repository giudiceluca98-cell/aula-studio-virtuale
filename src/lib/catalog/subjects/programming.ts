...
export const programmingSubjectPackage: SubjectPackage = {
  ...
  stages: programmingLesson.modules.map((module, order) => {
    ...
    return {
      ...
      activities: ["Esercizio guidato", "Esercizi autonomi", "Quiz", "Python Project", "Prova finale di padronanza"],
      ...
      googleQueries: queries(order === 0 ? "programmazione computer esecuzione programmi" : "ambiente sviluppo installare Python", order === 0 ? "programming computer program execution" : "Python development environment installation"),
    };
  }),
