...
const officialLessons = [...officialContent.lessons, lesson03Content, lesson04Content, lesson05Content, lesson06Content, lesson07Content, lesson08Content, lesson09Content, lesson11Content];
...
export const programmingLesson = {
  ...
  title: "Programmazione da Zero · Lezioni 0.1–1.1",
