...
export function eveLessonAdvice(stateValue: unknown) {
  ...
  return { title: "Controlla i criteri", message: "Rivedi i criteri di completamento delle lezioni 0.1–1.6.", sectionIds: ["programming-0-1-chapter-10", "programming-0-2-chapter-10", "programming-0-3-chapter-10", "programming-0-4-chapter-10", "programming-0-5-chapter-10", "programming-0-6-chapter-12", "programming-0-7-chapter-12", "programming-0-8-chapter-12", "programming-0-9-chapter-10", "programming-1-1-chapter-10", "programming-1-2-chapter-10", "programming-1-3-chapter-10", "programming-1-4-chapter-10", "programming-1-5-chapter-10", "programming-1-6-chapter-10"] };
}
