...
export const EVE_FEATURE_REGISTRY = Object.freeze([
  ...
  feature("agent", "prototype_adapter", true, "EVE_GROUNDED_CHAT_ENABLED", ["fastapi.rag", "fastapi.chat-production", "supabase.private-chat"], "Chat privata grounded con modello reale, citazioni verificate, profondità e output distinti per fatti, ipotesi e suggerimenti."),
