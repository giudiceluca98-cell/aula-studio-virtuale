...
import { ArrowRight, Bot, DoorOpen, Loader2, LogOut, Plus, Sparkles, UsersRound } from "lucide-react";
  ...
  return (
    <main data-ui-surface="dark" data-ui-page="dashboard" className="min-h-screen px-5 py-5 sm:px-8 lg:px-12">
      <nav className="mx-auto flex max-w-6xl items-center justify-between">
        <Link href="/" className="flex items-center gap-3 font-bold"><AppLogo size="sm" showName priority /></Link>
