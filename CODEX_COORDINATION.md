...
|---|---|---|---|---|---|---|---|
| Sostituzione app con demo canonica | Codex | `agent/canonical-app-replacement` | In corso | shell canonica, Dashboard, Aula, workspace, autenticazione, CSS e test di parità | `src/components/room/study-room.tsx`; Catalogo soltanto nella relativa fase | Da aprire come Draft PR; nessun deploy prima dell’anteprima approvata | 2026-07-23 |
