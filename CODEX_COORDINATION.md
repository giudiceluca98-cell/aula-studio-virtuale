...
| Completamento Programmazione da zero · Lezione 1.5 | Codex — contenuto ufficiale 1.5 convertito in codice | `codex/programming-zero-lesson-1-5` | In corso | Artefatto 1.5, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-1-4` | 2026-07-22 |
