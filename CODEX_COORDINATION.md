...
| Completamento Programmazione da zero · Lezione 1.7 | Codex — conversione della fonte ufficiale 1.7 | `codex/programming-zero-lesson-1-7` | In corso | Artefatto 1.7, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-1-6` | 2026-07-22 |
