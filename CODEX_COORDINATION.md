...
| Completamento Programmazione da zero · Lezione 1.2 | Codex — contenuto ufficiale 1.2 convertito in codice | `codex/programming-zero-lesson-1-2` | In corso | Artefatto 1.2, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-1-1` | 2026-07-21 |
