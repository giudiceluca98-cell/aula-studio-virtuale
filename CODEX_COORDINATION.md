...
| Completamento Programmazione da zero · Lezione 1.6 | Codex — conversione della fonte ufficiale 1.6 | `codex/programming-zero-lesson-1-6` | In corso | Artefatto 1.6, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-1-5` | 2026-07-22 |
