...
| Completamento Programmazione da zero · Lezione 0.5 | Codex — artefatto ufficiale 0.5 da PR #11, integrazione sicura su `main` | `agent/python-project-lesson-0-4` | In corso | Artefatto 0.5, aggregatore, progressi e test | Nessuno | [PR #14](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/14) | 2026-07-21 |
...
| Python Project Lezioni 0.4 e 0.5 | Codex | `agent/python-project-lesson-0-4` | In corso | aggregatore, progressi e test Python Project | `src/components/room/programming-lesson-workspace.tsx` (modifica minima al solo Python Project) | [PR #14](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/14) | 2026-07-21 |
