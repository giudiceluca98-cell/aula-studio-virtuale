...
| Completamento Programmazione da zero · Lezione 0.7 | Codex — contenuto ufficiale 0.7 convertito in codice | `codex/programming-zero-lesson-0-7` | In corso | Artefatto 0.7, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-0-6` | 2026-07-21 |
