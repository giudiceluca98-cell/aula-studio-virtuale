...
| Completamento Programmazione da zero · Lezione 0.9 | Codex — contenuto ufficiale 0.9 convertito in codice | `codex/programming-zero-lesson-0-9` | In corso | Artefatto 0.9, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-0-8` | 2026-07-21 |
