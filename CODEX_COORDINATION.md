...
| Completamento Programmazione da zero · Lezione 2.2 | Codex — conversione della fonte ufficiale 2.2 | `codex/programming-zero-lesson-2-2` | In corso | Artefatto 2.2, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-2-1` | 2026-07-22 |
