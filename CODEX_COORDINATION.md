...
| Completamento Programmazione da zero · Lezione 1.9 | Codex — conversione della fonte ufficiale 1.9 | `codex/programming-zero-lesson-1-9` | In corso | Artefatto 1.9, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-1-8` | 2026-07-22 |
