...
| Completamento Programmazione da zero · Lezione 1.3 | Codex — contenuto ufficiale 1.3 convertito in codice | `codex/programming-zero-lesson-1-3` | In corso | Artefatto 1.3, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `main` dopo PR #29 | 2026-07-21 |
