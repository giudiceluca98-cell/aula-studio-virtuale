...
|---|---|---|---|---|---|---|---|
| Contenuti ufficiali dei corsi nella demo canonica | Codex | `agent/demo-course-content-sync` | In revisione | generatore, pacchetto `reference/course-content/**`, demo integrata e test mirati | demo canonica autonoma `1.4.0-alpha.1` letta senza modificarne il checkpoint | [PR #66](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/66) · SHA ufficiale verificato, test 6/6 e build superati | 2026-07-23 |
| Correzione pubblicazione checkpoint 1.4 autonomo | Codex | `agent/phase4-publisher-fix-2` | Completato | controlli del workflow 1.4 | nessuno | [PR #67](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/67), [PR #68](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/68) · workflow riuscito | 2026-07-23 |
