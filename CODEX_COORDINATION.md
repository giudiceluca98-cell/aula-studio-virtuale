...
| Completamento Programmazione da zero · Lezione 0.6 | Codex — contenuto ufficiale 0.6 convertito in codice | `codex/programming-zero-lesson-0-6` | In corso | Artefatto 0.6, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-0-5` | 2026-07-21 |
