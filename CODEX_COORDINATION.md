...
| Completamento Programmazione da zero · Lezione 1.1 | Codex — contenuto ufficiale 1.1 convertito in codice | `codex/programming-zero-lesson-1-1` | In corso | Artefatto 1.1, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-0-9` | 2026-07-21 |
