...
| Completamento Programmazione da zero · Lezione 0.9 | Codex — artefatto ufficiale 0.9 da PR #16, integrazione sicura su `main` | `agent/integrate-programming-lesson-0-9` | In corso | Artefatto 0.9, aggregatore, progressi e test Python Project | Nessuno | PR da aprire | 2026-07-21 |
