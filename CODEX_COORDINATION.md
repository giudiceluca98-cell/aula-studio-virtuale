...
| Completamento Programmazione da zero · Lezione 0.4 | Codex — contenuto ufficiale 0.4 convertito in codice | `codex/programming-zero-lesson-0-4` | In revisione | Artefatto 0.4, aggregatore, progressi e test | Nessuno | [PR #9](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/9) | 2026-07-21 |
| Completamento Programmazione da zero · Lezione 0.5 | Codex — contenuto ufficiale 0.5 convertito in codice | `codex/programming-zero-lesson-0-5` | In revisione | Artefatto 0.5, aggregatore, progressi e test | Nessuno | [PR #11](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/11), base `codex/programming-zero-lesson-0-4` | 2026-07-21 |
| Completamento Programmazione da zero · Lezione 0.6 | Codex — contenuto ufficiale 0.6 convertito in codice | `codex/programming-zero-lesson-0-6` | In revisione | Artefatto 0.6, aggregatore, progressi e test | Nessuno | [PR #12](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/12), base `codex/programming-zero-lesson-0-5` | 2026-07-21 |
| Completamento Programmazione da zero · Lezione 0.7 | Codex — contenuto ufficiale 0.7 convertito in codice | `codex/programming-zero-lesson-0-7` | In revisione | Artefatto 0.7, aggregatore, progressi e test | Nessuno | [PR #13](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/13), base `codex/programming-zero-lesson-0-6` | 2026-07-21 |
| Completamento Programmazione da zero · Lezione 0.8 | Codex — contenuto ufficiale 0.8 convertito in codice | `codex/programming-zero-lesson-0-8` | In revisione | Artefatto 0.8, aggregatore, progressi e test | Nessuno | [PR #15](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/15), base `codex/programming-zero-lesson-0-7` | 2026-07-21 |
| Completamento Programmazione da zero · Lezione 0.9 | Codex — contenuto ufficiale 0.9 convertito in codice | `codex/programming-zero-lesson-0-9` | In revisione | Artefatto 0.9, aggregatore, progressi e test | Nessuno | [PR #16](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/16), base `codex/programming-zero-lesson-0-8` | 2026-07-21 |
| Completamento Programmazione da zero · Lezione 1.1 | Codex — contenuto ufficiale 1.1 convertito in codice | `codex/programming-zero-lesson-1-1` | In revisione | Artefatto 1.1, aggregatore, progressi, pacchetto e test | `src/lib/catalog/roadmap.ts` | [PR #17](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/17), base `codex/programming-zero-lesson-0-9` | 2026-07-21 |
| Completamento Programmazione da zero · Lezione 1.2 | Codex — contenuto ufficiale 1.2 convertito in codice | `codex/programming-zero-lesson-1-2` | In revisione | Artefatto 1.2, aggregatore, progressi e test | Nessuno | [PR #20](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/20), base `codex/programming-zero-lesson-1-1` | 2026-07-21 |
...
| Python Project guidati | Codex | `codex/guided-python-projects` | In revisione | runner, aggregatore, progressi, area di lavoro, API e test | `src/components/room/programming-lesson-workspace.tsx` (area protetta) | [PR #8](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/8) | 2026-07-21 |
