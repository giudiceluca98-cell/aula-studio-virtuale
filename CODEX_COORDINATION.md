...
| Completamento Programmazione da zero · Lezione 2.3 | Codex — conversione della fonte ufficiale 2.3 | `codex/programming-zero-lesson-2-3` | In corso | Artefatto 2.3, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-2-2` | 2026-07-22 |
