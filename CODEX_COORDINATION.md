...
|---|---|---|---|---|---|---|---|
| Sostituzione app con demo canonica | Codex | `agent/canonical-app-replacement` | In corso | documento canonico pubblico, routing di ingresso, script e test di parità | nessuno; la vecchia interfaccia non viene modificata | [PR #70](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/70) · nessun deploy prima dell’anteprima approvata | 2026-07-23 |
