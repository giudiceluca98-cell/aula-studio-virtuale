...
| Completamento Programmazione da zero · Lezione 1.8 | Codex — conversione della fonte ufficiale 1.8 | `codex/programming-zero-lesson-1-8` | In corso | Artefatto 1.8, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-1-7` | 2026-07-22 |
