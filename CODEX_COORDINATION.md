...
|---|---|---|---|---|---|---|---|
| Contenuti ufficiali dei corsi nella demo canonica | Codex | `agent/demo-course-content-sync` | In corso | generatore e pacchetto `reference/course-content/**`, loader canonico e test mirati | nessuno | da aprire | 2026-07-23 |
