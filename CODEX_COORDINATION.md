...
| Completamento Programmazione da zero · Lezione 0.5 | Codex — contenuto ufficiale 0.5 convertito in codice | `codex/programming-zero-lesson-0-5` | In corso | Artefatto 0.5, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-0-4` | 2026-07-21 |
