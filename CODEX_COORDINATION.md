...
| Completamento Programmazione da zero · Lezione 1.4 | Codex — contenuto ufficiale 1.4 convertito in codice | `codex/programming-zero-lesson-1-4` | In corso | Artefatto 1.4, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-1-3` | 2026-07-21 |
