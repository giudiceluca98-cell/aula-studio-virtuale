...
| Completamento Programmazione da zero · Lezione 0.6 | Codex — artefatto ufficiale 0.6 da PR #12, integrazione sicura su `main` | `agent/integrate-programming-lesson-0-6` | In corso | Artefatto 0.6, aggregatore, progressi e test Python Project | Nessuno | [PR #19](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/19) | 2026-07-21 |
