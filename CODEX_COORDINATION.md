...
| Completamento Programmazione da zero · Lezione 0.8 | Codex — artefatto ufficiale 0.8 da PR #15, integrazione sicura su `main` | `agent/integrate-programming-lesson-0-8` | In corso | Artefatto 0.8, aggregatore, progressi e test Python Project | Nessuno | PR da aprire | 2026-07-21 |
