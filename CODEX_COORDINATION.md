...
| Quiz interattivi dentro i capitoli | Codex | `codex/inline-chapter-quiz` | In revisione | area di lavoro e test dedicati | `src/components/room/programming-lesson-workspace.tsx` (area protetta) | [PR #7](https://github.com/giudiceluca98-cell/aula-studio-virtuale/pull/7) | 2026-07-21 |
