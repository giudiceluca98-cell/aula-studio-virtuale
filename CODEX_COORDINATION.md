...
| Python Project guidati | Codex | `codex/guided-python-projects` | In corso | runner, aggregatore, progressi, area di lavoro, API e test | `src/components/room/programming-lesson-workspace.tsx` (area protetta) | Da aprire | 2026-07-21 |
