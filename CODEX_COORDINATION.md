...
| Completamento Programmazione da zero · Lezione 0.8 | Codex — contenuto ufficiale 0.8 convertito in codice | `codex/programming-zero-lesson-0-8` | In corso | Artefatto 0.8, aggregatore, progressi e test | Nessuno | Draft PR da aprire, base `codex/programming-zero-lesson-0-7` | 2026-07-21 |
